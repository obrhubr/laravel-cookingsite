...
@section('content')
    ...
    <div class="flex flex-col mb-4">
        ...
        <form method="POST" href="/recipees/add" enctype="multipart/form-data">
            @csrf

            <div class="flex flex-col mb-4">
                <input placeholder="Name..." class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-sm border border-blueGray-300 outline-none focus:outline-none focus:ring w-full" id="name" name="name">
                <div class="my-1"></div>
                <input placeholder="Description..." class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-sm border border-blueGray-300 outline-none focus:outline-none focus:ring w-full" id="description" name="description">
            </div>
            ...
            <div id="ingredient-container" class="flex flex-col mb-4">
                ...
                <p>
                    ...
                    {{-- <input placeholder="Ingredient Name..." class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-sm border border-blueGray-300 outline-none focus:outline-none focus:ring w-full" id="ingredients[0][name]" name="ingredients[0][name]"> --}}
                </p>
                <div class="my-1"></div>
                <p>
                    <input placeholder="Ingredient Amount (number)..." class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white rounded text-sm border border-blueGray-300 outline-none focus:outline-none focus:ring w-full" onkeypress='validate(event)' id="ingredients[0][amount]" name="ingredients[0][amount]">
                </p>
            </div>
            <div class="my-5"></div>
            <div class="text-center justify-center">
                <div class="" class="flex flex-col mb-4">
                    <a href="javascript:;" id="add-new-ingredient" class="h-10 p-3 text-white transition-colors duration-150 bg-blue-700 rounded-md focus:shadow-outline hover:bg-blue-800">Add new Ingredient</a>
                </div>

                <div class="my-5"></div>

                <input class="h-10 p-3 text-white transition-colors duration-150 bg-yellow-400 rounded-md focus:shadow-outline hover:bg-yellow-600" value="Submit" type="submit">
            </div>
        </form>
        <script>
            let i = 1;
